...
UML(Unified Modeling Language)은 대표적인 객체-지향 시스템 설계용 도구입니다. 구조적 다이어그램으로 시스템의 정적인 구조를 나타내고 행위 다이어그램으로 시스템의 행위를 나타냅니다. 
...
SADT는 SoftTech에서 1970년대에 개발한 S/W 설계용 UpperCASE 도구입니다. 시각적인 요소(블록 다이어그램)을 활용합니다. 현대적인 UML이 등장하기 전에 많이 사용되었던 도구입니다.
