...
함수의 가장 큰 장점 중에 하나가 바로 인자입니다. 함수는 입력값을 받을 수 있으며 입력값에 따라 다른 작업을 수행할 수 있습니다. 함수를 정의할 때 입력값을 치환한 변수를 매개변수(Parameters)라고 하고 함수를 호출할 때 실제 입력되는 값을 인자 (Arguments)라고 합니다.
